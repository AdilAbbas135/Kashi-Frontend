    ...
    <footer className="bg-gray-900 text-white py-10 mt-20">
      <div className="container mx-auto flex flex-wrap justify-between mt-10">
        ...
        <div className="w-full md:w-1/4">
          ...
          <p className="text-sm mb-4">Sign up to receive our latest news and updates.</p>
          <form className="mb-4">
            <input type="email" className="block w-full rounded-sm py-2 px-3 mb-2 text-sm" placeholder="Enter your email" />
            <button type="submit" className="bg-white text-gray-900 py-2 px-4 rounded-sm text-sm">Subscribe</button>
          </form>
        </div>
      </div>
      <div className="container mx-auto pt-4 border-t border-gray-800">
        <p className="text-center text-sm text-gray-500">&copy; {new Date().getFullYear()} Green Valley. All rights reserved.</p>
      </div>
    </footer>
  );
};
